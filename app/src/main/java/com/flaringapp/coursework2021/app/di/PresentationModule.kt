...
import com.flaringapp.coursework2021.presentation.features.transaction.create.model.CreateTransactionModelImpl
...
val PresentationModule = module {
    ...
    viewModel<RoomsListModel> { RoomsListModelImpl(get(), get(), get(), get()) }
